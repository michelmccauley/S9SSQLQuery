...
namespace SQLSelectQuery
{
                ...
                if (File.Exists(mappingfile))
                {
                    ...
                    if (workflowID != "")
                    {
                        ...
                        if (workflowProperties != null)
                        {
                            ...
                            returnID1 = workflowProperties.ReturnValue1;
                            returnID2 = workflowProperties.ReturnValue2;
                            returnID3 = workflowProperties.ReturnValue3;
                            returnID4 = workflowProperties.ReturnValue4;
                            returnID5 = workflowProperties.ReturnValue5;                  
                        }
                        else
                        {
                           ...
                           while (reader.Read())
                            {
                                if (reader[0] != null)
                                {
                                    ...
                                    Output.Add(returnID1, reader[0].ToString());
                                    Output.Add(returnID2, reader[1].ToString());
                                    Output.Add(returnID3, reader[2].ToString());
                                    Output.Add(returnID4, reader[3].ToString());
                                    Output.Add(returnID5, reader[4].ToString());
                                }
                                else
                                {
                                    Output.Add(returnID1, "No Data");
                                    Output.Add(returnID2, "No Data");
                                    Output.Add(returnID3, "No Data");
                                    Output.Add(returnID4, "No Data");
                                    Output.Add(returnID5, "No Data");
                                }
                            }
                        }
    ...
    public class PropertyMap
    {
        ...
        private string returnValueField1;
        private string returnValueField2;
        private string returnValueField3;
        private string returnValueField4;
        private string returnValueField5;
        ...
        public string ReturnValue1
        {
            get
            {
                return this.returnValueField1;
            }
            set
            {
                this.returnValueField1 = value;
            }
        }
        public string ReturnValue2
        {
            get
            {
                return this.returnValueField2;
            }
            set
            {
                this.returnValueField2 = value;
            }
        }
        public string ReturnValue3
        {
            get
            {
                return this.returnValueField3;
            }
            set
            {
                this.returnValueField3 = value;
            }
        }
        public string ReturnValue4
        {
            get
            {
                return this.returnValueField4;
            }
            set
            {
                this.returnValueField4 = value;
            }
        }
        public string ReturnValue5
        {
            get
            {
                return this.returnValueField5;
            }
            set
            {
                this.returnValueField5 = value;
            }
        }
    }
}
